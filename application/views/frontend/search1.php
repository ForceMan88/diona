                    ...
                    <li class="item<?php echo $item->entity_id ?>">
                        ...
                        <div class="numbers_info">
                            ...
                            <div class="numbers_info_foto">
                                ...
                                <?php // foreach ($data as $image) : ?>
                                    <img src="<?php //echo skin_url($image) ?>">
                                    <?php // endforeach; ?>
                                <?php // endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="basis_info">
                            <div class="basis_info_a">
                                ...
                                <span><strong>Кол-комн:&nbsp</strong><?php echo $item->count_room ?></span>
                                <?php endif;?>

                                <span>улица:&nbsp<?php echo $item->street ?></span>
                                ...
                                <?php if (!empty($item->type_room) and $item->type_room !='.'): ?>
                                    <span>Тип комнат:<?php echo $item->type_room ?></span>
                                <?php endif;?>
                                ...
                                <?php if (!empty($item->material)): ?>
                                    <span>Материал : <?php echo $material[$item->material] ?></span></br>
                                <?php endif;?>
                            </div>
