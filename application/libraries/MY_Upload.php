...
class MY_Upload extends CI_Upload{
	...
	public function do_multi_upload( $field = 'userfile', $return_info = TRUE , $entity_id, $config){
		...
		if( is_array( $_FILES[$field] ) )
		{
			...
			for($i = 0; $i < $count; $i++)
			{
                ...
                $this->_setImageEntity($entity_id, $this->file_name);
    ...
    protected function _setImageEntity($entity_id, $file_name)
    {
        $CI =& get_instance();
        $CI->load->model('admin/sales', 'sales');
        $CI->sales->setImage($entity_id, $file_name);
    }
